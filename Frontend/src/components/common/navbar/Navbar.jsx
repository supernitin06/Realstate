          ...
          <div className="container flex flex-wrap items-center justify-between mx-auto p-4">
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <div>
                <button
                  text="white"
                  className=" justify-center text-xl items-center gap-1 text-white flex py-2 px-4 rounded"
                >
                  <span>
            ...
            <div className="flex items-center    space-x-10 rtl:space-x-reverse">
              <div className="relative hidden md:block">
                ...
                <input
                  ...
                  id="search-navbar"
                  placeholder="Search..."
                  className="block  p-3 ps-10 w-[350px] text-lg text-gray-900  outline-0
                           rounded-lg bg-white"
                />
              </div>
              <div>
...
//                          focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1"
//                         >
//                             <svg
//                                 className="w-5 h-5"
//                                 aria-hidden="true"
